...
export const contentPages: readonly ContentPage[] = [
  {
    ...
    checklist: ["Як проходить навчання", "Хто супроводжує учня", "Які цифрові сервіси підключені"]
  },
  {
    slug: "branches",
    title: "Філіали",
    ...
    highlights: ["5 активних філій", "Єдиний CRM-процес", "Телефони і маршрути"],
  ...
  },
  {
    ...
    highlights: ["Теорія від 4 000 грн", "Практика окремо", "Платежі через API"],
  ...
  },
  {
    ...
    checklist: ["Оберіть філію", "Подзвоніть або напишіть", "Отримайте консультацію"]
  },
  {
    slug: "news",
    title: "Новини",
  ...
  },
  {
    ...
    highlights: ["1 хвилина", "Категорія і місто", "Дзвінок менеджера"],
    checklist: ["Вкажіть телефон", "Оберіть категорію", "Дочекайтесь дзвінка"],
  ...
  },
  {
    ...
    checklist: ["Залиште телефон", "Погодьте графік", "Почніть теорію"],
  ...
  },
  {
    ...
    eyebrow: "SEO-сторінка категорії",
    kind: "category",
    category: "A",
